...
import GraphData from "../assets/json/countryGraph.json";
import '../assets/css/LandingGraph.css';

const LandingGraph = (props)=>{
    ...
    useEffect(()=>{
        ...
        // // var tooltip = svg.append("div").attr("class", "toolTip").style({
        ...
        //     var node = svg.select('#flags').selectAll("img")
        //     .data(force.nodes())
        //     .enter().append('img')
