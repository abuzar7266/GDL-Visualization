// https://observablehq.com/@d3/force-directed-graph@327
...
This network of character co-occurence in _Les Misérables_ is positioned using [D3’s force layout](https://github.com/d3/d3-force). Color represents arbitrary clusters in the data. Drag nodes below to better understand connections. See also a [disconnected graph](/@d3/disjoint-force-directed-graph), a [canvas version](https://observablehq.com/@d3/force-directed-graph-canvas), and compare to [WebCoLa](/@mbostock/hello-cola). Data: [Stanford Graph Base](https://www-cs-faculty.stanford.edu/~knuth/sgb.html)`
)}
