...
var Button = React13.forwardRef(({
  ...
  return (0, import_jsx_runtime12.jsx)(Component2, {
    ...
    ...props,
    ref,
    className: (0, import_classnames11.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size2 && `${prefix}-${size2}`, props.href && props.disabled && "disabled")
  });
});
...
ButtonToolbar.defaultProps = defaultProps7;
...
Card.defaultProps = defaultProps8;
...
var Carousel = React21.forwardRef((uncontrolledProps, ref) => {
  const {
    as: Component2 = "div",
    bsPrefix,
    slide,
...
var $704cf1d3b684cc5c$var$SSRContext = import_react14.default.createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  ...
  return import_react14.default.createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
var DropdownToggle2 = React32.forwardRef(({
  ...
  return (0, import_jsx_runtime31.jsx)(Component2, {
    className: (0, import_classnames22.default)(className, prefix, split && `${prefix}-split`, !!isInputGroup && (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
  ...
  return (0, import_jsx_runtime32.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime32.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime32.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames23.default)(className, show && "show", (!drop || drop === "down") && prefix, drop === "up" && "dropup", drop === "end" && "dropend", drop === "start" && "dropstart")
      })
    })
  });
});
...
FormLabel.defaultProps = defaultProps13;
...
Container.defaultProps = defaultProps14;
...
Image.defaultProps = defaultProps15;
...
FigureImage.defaultProps = defaultProps16;
...
var ModalDialog = React55.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames41.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime57.jsx)("div", {
      className: (0, import_classnames41.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
ModalHeader.defaultProps = defaultProps17;
...
var Modal = React57.forwardRef(({
  ...
  const renderBackdrop = (0, import_react31.useCallback)((backdropProps) => (0, import_jsx_runtime59.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime59.jsx)("div", {
    ...
    className: (0, import_classnames43.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
...
Modal.defaultProps = defaultProps18;
...
var NavDropdown = React58.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime61.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames44.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime60.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime60.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Overlay = React59.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime62.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
Popover.defaultProps = defaultProps19;
...
Overlay2.defaultProps = defaultProps20;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime68.jsxs)(import_jsx_runtime67.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react36.cloneElement)(children, triggerProps), (0, import_jsx_runtime66.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
OverlayTrigger.defaultProps = defaultProps21;
...
PageItem.defaultProps = defaultProps22;
...
ProgressBar.defaultProps = defaultProps23;
...
Ratio.defaultProps = defaultProps24;
...
Tabs2.defaultProps = defaultProps26;
...
ToastHeader.defaultProps = defaultProps27;
...
ToggleButtonGroup.defaultProps = defaultProps28;
...
var Tooltip = React88.forwardRef(({
  bsPrefix,
  placement,
  className,
  style,
  ...
  return (0, import_jsx_runtime100.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime99.jsx)("div", {
      ...
      ...arrowProps
    }), (0, import_jsx_runtime99.jsx)("div", {
      className: `${bsPrefix}-inner`,
      children
    })]
  });
});
Tooltip.defaultProps = defaultProps29;
