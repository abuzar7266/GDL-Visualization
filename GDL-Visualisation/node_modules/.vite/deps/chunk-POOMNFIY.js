...
var NavbarBrand = React7.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var divWithClassName_default = (className) => React11.forwardRef((p, ref) => (0, import_jsx_runtime9.jsx)("div", {
  ...p,
  ref,
...
var Modal = (0, import_react13.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime10.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime10.jsx)("div", Object.assign({}, dialogProps, {
    children: React12.cloneElement(children, {
      role: "document"
    })
  }));
  if (Transition2) {
    dialog = (0, import_jsx_runtime10.jsx)(Transition2, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition2) {
      backdropElement = (0, import_jsx_runtime10.jsx)(BackdropTransition2, {
        appear: true,
        in: !!show,
  ...
  return (0, import_jsx_runtime10.jsx)(import_jsx_runtime11.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime12.jsxs)(import_jsx_runtime11.Fragment, {
...
var OffcanvasToggling = React13.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(TransitionWrapper_default, {
    ...
    children: (status, innerProps) => React13.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames7.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
OffcanvasToggling.defaultProps = defaultProps6;
...
var Offcanvas = React14.forwardRef(({
  ...
  const renderBackdrop = (0, import_react14.useCallback)((backdropProps) => (0, import_jsx_runtime14.jsx)("div", {
    ...backdropProps,
...
Offcanvas.defaultProps = defaultProps7;
...
var NavbarCollapse = React15.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime17.jsx)(Collapse_default, {
...
var NavbarToggle = React16.forwardRef(({
  bsPrefix,
  className,
  children,
  label,
  ...
  return (0, import_jsx_runtime18.jsx)(Component, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames9.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime18.jsx)("span", {
      className: `${bsPrefix}-icon`
    })
  });
});
NavbarToggle.displayName = "NavbarToggle";
NavbarToggle.defaultProps = defaultProps8;
 ...
 */
//# sourceMappingURL=chunk-POOMNFIY.js.map
